#from pair import user
class AVLTree():
    # Function to insert a node
    def __init__(self):
        self.root=None
    def insert_node(self, root, user): 
        ...
        if not root:
            ...
            root.left_child = self.insert_node(root.left_child, user)
        else:
            root.right_child = self.insert_node(root.right_child, user)
    ...
    def delete_node(self, root, user):
        ...
        if not root:
            ...
            root.left_child = self.delete_node(root.left_child, user)
        elif user.id > root.id:
            root.right_child = self.delete_node(root.right_child, user)
        else:
