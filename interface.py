...
def main():
    ...
    male_pic = pygame.image.load("male.png")
    female_pic = pygame.image.load("female.png")
    sports_pic = pygame.image.load("sports.png")
    read_pic = pygame.image.load("read.png")
    dance_pic = pygame.image.load("dance.png")
    travel_pic = pygame.image.load("travel.png")
    write_pic = pygame.image.load("write.png")
    draw_pic = pygame.image.load("draw.png")
    movie_pic = pygame.image.load("movie.png")
    music_pic = pygame.image.load("music.png")
    game_pic = pygame.image.load("game.png")
    sign_up_pic = pygame.image.load("sign_up.png")
    register_success_pic = pygame.image.load("register_success.png")
    word = ''
    name = ''
    age = ''
    gender = ''
